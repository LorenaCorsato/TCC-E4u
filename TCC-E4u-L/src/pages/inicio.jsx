...
export default function Inicio() {
  ...
  const beneficiosPopups = [
    ...
    },
    {
      ...
      fullContent: "Controlando a pegada de carbono, você poderá melhorar a qualidade do ar, conscientizar pessoas ao redor e atingir uma melhor qualidade de vida. Você pode fazer a diferença na sua comunidade e no mundo.  "
    },
    {
