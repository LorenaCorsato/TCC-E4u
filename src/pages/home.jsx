          ...
          <div className="containerCards">
            <div className="itemCard">
              <a href="#" className="linkCard">
                ...
                <h2 className="tituloCard">Amanhecer Solar</h2>
                <div className="detalhesCard">
                  ...
                  <div className="linhaDetalhe">
                    ...
                    <span className="valorDetalhe">amanhecer@gmail.com</span>
                  </div>
                  <div className="linhaDetalhe">
                  ...
                  <div className="linhaDetalhe">
                    ...
                    <span className="valorDetalhe">www.amanhecerSolar.com</span>
                  </div>
                </div>
            ...
            <div className="itemCard">
              <a href="#" className="linkCard">
                ...
                <h2 className="tituloCard">SolarMax</h2>
                <div className="detalhesCard">
                  <div className="linhaDetalhe">
                    <span className="rotuloDetalhe">CEP:</span>
                  ...
                  <div className="linhaDetalhe">
                    <span className="rotuloDetalhe">E-mail:</span>
                    <span className="valorDetalhe">solarMax@gmail.com</span>
                  </div>
                  <div className="linhaDetalhe">
                    <span className="rotuloDetalhe">Telefone:</span>
                  ...
                  <div className="linhaDetalhe">
                    <span className="rotuloDetalhe">Site:</span>
                    <span className="valorDetalhe">www.solarMax-rj.com</span>
                  </div>
                </div>
                <button className="botaoCard">Contatar</button>
              </a>
            ...
            <div className="itemCard">
              <a href="#" className="linkCard">
                ...
                <h2 className="tituloCard">EcoLuz</h2>
                <div className="detalhesCard">
                  <div className="linhaDetalhe">
                    <span className="rotuloDetalhe">CEP:</span>
                  ...
                  <div className="linhaDetalhe">
                    <span className="rotuloDetalhe">E-mail:</span>
                    <span className="valorDetalhe">ecoLuz@gmail.com</span>
                  </div>
                  <div className="linhaDetalhe">
                    <span className="rotuloDetalhe">Telefone:</span>
                  ...
                  <div className="linhaDetalhe">
                    <span className="rotuloDetalhe">Site:</span>
                    <span className="valorDetalhe">www.ecoLuz-mg.com</span>
                  </div>
                </div>
                <button className="botaoCard">Contatar</button>
              </a>
            ...
            <div className="itemCard">
              <a href="#" className="linkCard">
                ...
                <h2 className="tituloCard">Cêu Solar</h2>
                <div className="detalhesCard">
                  <div className="linhaDetalhe">
                    <span className="rotuloDetalhe">CEP:</span>
                  ...
                  <div className="linhaDetalhe">
                    <span className="rotuloDetalhe">E-mail:</span>
                    <span className="valorDetalhe">ceuSolar@gmail.com</span>
                  </div>
                  <div className="linhaDetalhe">
                    <span className="rotuloDetalhe">Telefone:</span>
                  ...
                  <div className="linhaDetalhe">
                    <span className="rotuloDetalhe">Site:</span>
                    <span className="valorDetalhe">www.ceuSolar.com</span>
                  </div>
                </div>
                <button className="botaoCard">Contatar</button>
              </a>
