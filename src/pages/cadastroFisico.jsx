...
export default function CadastroFisico() {
    ...
    const [concordaTermosModal, setConcordaTermosModal] = useState(false); 
    ...
    const handleCadastroFisico = async (evento) => {
        ...
        if (usuarioGoogle) {
            ...
            payload = { email, cpf: cpf.replace(/\D/g, ''), senha };
        }
    ...
    return (
        <div className="login">
            ...
            <div className="formulario">
                ...
                <p>Olá, {usuarioGoogle?.displayName}! Por favor, informe seu CPF para finalizar.</p>
                <form onSubmit={handleCompleteGoogleRegistration} style={{ marginTop: '20px' }}>
                    <input
                        type="text"
                        placeholder="Digite seu CPF"
                        value={cpfModal}
                        onChange={(e) => setCpfModal(formatarCpf(e.target.value))}
                        maxLength="14"
                        required
                        style={{ width: '80%', padding: '10px', fontSize: '1rem' }}
                    />
                    <br/>
                    <div className="termos-container-modal">
                            <input 
                                type="checkbox"
                                id="termosModal"
