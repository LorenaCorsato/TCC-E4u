    ...
    return (
        <>
            ...
            <div className="resultado-container">
                ...
                <p className="citacao-calculo">
                    Cálculo de potência baseado nos dados do <a href="http://labren.ccst.inpe.br/" target="_blank" rel="noopener noreferrer">Atlas Brasileiro de Energia Solar, INPE, 2017</a>.
                </p>
                        ...
                        {resultadosOrdenados.map((item) => ( 
                            <SwiperSlide key={item.id}>
                                <div className={`placa-card ${!item.cabe_no_espaco ? 'nao-cabe' : ''}`}>
                                    ...
                                    <p className="imagem_ilustrativa"> *Imagem meramente ilustrativa*</p>
