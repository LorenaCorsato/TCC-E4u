    ...
    return (
        <>
            ...
            <div className="alternativas">
                <div>
                <input type="checkbox" id="alternativa1" className="alternativa"  value="Boat" />
                <label for="alternativa1">{alternativa1}</label>
                </div>
                <div>
                <input type="checkbox" id="alternativa2" className="alternativa" value="Boat" />
                <label for="alternativa2">{alternativa2}</label>
                </div>
                <div>
                <input type="checkbox" id="alternativa3" className="alternativa" value="Boat" />
                <label for="alternativa3">{alternativa3}</label>
                </div>
                <div>
                <input type="checkbox" id="alternativa4" className="alternativa" value="Boat" />
