...
export default function Inicio() {
  ...
  function MudarParagrafo1() {
    setParagrafos(["A maneira como trabalhamos e os problemas que procuramos resolver devem beneficiar e auxiliar usuários de todo o estado de São Paulo, independentemente de sua posição social ou de onde vivam.",
  ...
  function MudarParagrafo2() {
    setParagrafos(["Nos preocupamos com o meio ambiente e através do E4u toda interação é uma oportunidade de fortalecer nosso comprometimento e dar aos usuários a sensação de proximidade com os temas sustentáveis.",
  ...
  function MudarParagrafo3() {
    setParagrafos(["Mantemos os dados de nossos usuários em segurança, garantindo que não sejam vazados, roubados ou utilizados de maneira ilegal ou não autorizada.",
  ...
  function MudarParagrafo4() {
    setParagrafos(["Principalmente para empresas, os detalhes são muito importantes. Dedicamos muita atenção e planejamento nos gráficos, artigos e sugestões exibidos.",
  ...
  function MudarTitulo1() {
    setTitulo(["Apoiar usuários de diversos lugares:",
  ...
  function MudarTitulo2() {
    setTitulo(["Fazer parte da campanha sustentável:",
  ...
  function MudarTitulo4() {
    setTitulo(["Enfatizar os detalhes:",
    ...
    <>
      ...
      <div className="inicio">
        <div className="objetivos">
          <h1><span className="linha">Energia, Eficiência,<br />Ecologia, Economia</span></h1>
        ...
        <div className="beneficios">
          ...
          <div className="botoesBeneficios">
            ...
            <BotaoIcone onBtnIcone={MudarB2} srcBtnIcone="src/assets/icon - cofrinho.png" textoBtnIcone="Para o seu bolso" />
